...
\begin{itemize}[leftmargin=*]
  \item \textbf{Mini-Project (Module 3)}: Midterm project focused on foundational NLP methods.
...
\begin{itemize}[leftmargin=*]
  ...
  \item Deliverables: GitHub repository, short paper (3--4 pages), 5-minute presentation.
\end{itemize}

\subsection*{Suggested Tracks}
...
\begin{itemize}[leftmargin=*]
  ...
  \item Duration: Weeks 3--6 (8 weeks).
  \item Proposal approval required (Week 12 deadline).
  \item Deliverables: GitHub repository, 6--8 page paper (ACL-style), 10-minute demo presentation.
\end{itemize}
...
\subsection*{Proposal Requirements (Week 12)}
Each team submits a one-page PDF proposal including:
\begin{itemize}[leftmargin=*]
  \item Project title and motivation
  \item Research question and hypothesis
  \item Dataset(s) and expected preprocessing steps
  \item Baseline and planned experiments
  \item Evaluation metrics and timeline
\end{itemize}
