...
\section*{Homework Assignments (7 total) - Deadline: by the end of the 4th module in one collection}
\begin{enumerate}[leftmargin=1.25em]
  ...
  \item \textbf{HW5 (BERT Finetuning):}  TBD
  % Finetune a masked-LM encoder (e.g., \texttt{bert-base-uncased}) for NER or sentiment; ablations (Ch.\ 10).
  ...
  \item \textbf{HW7 (Instruction Tuning \& Safety):} TBD
  % Small-scale SFT/DPO experiment on a distilled model; evaluate helpfulness/harms; write reflection (Ch.\ 9).
\end{enumerate}

\section*{Projects}
\textbf{Mini-Project 1 (end of Week 8):} your proposed subject (short paper + 5-min talk).\\
\textbf{Final Project (Week 13):} your proposed subject approved by insructure. 
